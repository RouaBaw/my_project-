...
class EducationalPathController extends Controller
{
    ...
    public function publishedPaths()
    {
        ...
        $paths = EducationalPath::where(['status' => 'published'])->with(['creator:id,first_name,last_name', 'contents.packages', 'contents.questions.answers', 'contents.games'])->withCount([
            'contents',
