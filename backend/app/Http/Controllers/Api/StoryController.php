...
class StoryController extends Controller
{
    ...
    public function submitStory(Request $request, $id)
    {
        ...
        return DB::transaction(function () use ($request, $story, $questions, $totalQuestions) {
            ...
            if ($child && $child->isChild()) {
                PointsService::awardForStoryAttempt($child, $attempt->id, $correctCount);
                NotificationService::childFinishedActivity($child, 'story', $story, [
    ...
    public function submitForReview($id)
    {
        ...
        NotificationService::storySubmittedForReview($story, $story->creator_id);
