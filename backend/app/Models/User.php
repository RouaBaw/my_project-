...
class User extends Authenticatable
{
    ...
    public function storyAttempts()
    {
        return $this->hasMany(StoryAttempt::class, 'user_id');
    }
    public function childSubscriptions()
    {
        return $this->hasMany(ChildSubscription::class, 'child_id');
    }
    public function managedSubscriptions()
    {
        return $this->hasMany(ChildSubscription::class, 'parent_id');
    }
    public function reviewedSubscriptions()
    {
        return $this->hasMany(ChildSubscription::class, 'reviewed_by');
    }
    public function latestChildSubscription()
    {
        return $this->hasOne(ChildSubscription::class, 'child_id')->latestOfMany();
    }
    ...
    {
        return $this->hasMany(RewardRedemption::class, 'child_id');
    }
