...
class CoursesPage extends StatelessWidget {
            ...
            sliver: Obx(() {
              ...
              return SliverGrid(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  mainAxisExtent: 400.h, // تم تقليل الارتفاع ليتناسب مع المحتوى
                ),
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(title, style: TextStyle(fontSize: 28.sp, fontWeight: FontWeight.w900, color: const Color(0xFF1A202C), fontFamily: 'Tajawal')),
                    SizedBox(height: 8.h),
                    Text(desc, style: TextStyle(fontSize: 14.sp, color: const Color(0xFF718096), fontFamily: 'Tajawal')),
                  ],
                ),
              ),
              _buildBackButton(),
    ...
    return Container(
      ...
      child: Stack(
        children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          title,
                          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.sp, color: const Color(0xFF2D3748), fontFamily: 'Tajawal'),
                          maxLines: 1,
                      ...
                      Text(
                          content['description'] ?? '',
                          style: TextStyle(color: Colors.grey.shade500, fontSize: 12.sp, fontFamily: 'Tajawal'),
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis
                      ),
                      const Spacer(),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('عرض الدرس', style: TextStyle(color: const Color(0xFF4A90E2), fontWeight: FontWeight.bold, fontSize: 12.sp)),
                          // زر الإدارة يحتاج أن يكون فوق طبقة الـ InkWell
                        ],
                      ),
                    ],
                  ),
          ...
          // 2. طبقة النقر الشاملة (تغطي الكارد كاملاً)
          Positioned.fill(
            child: Material(
          ...
          // 3. طبقة زر إدارة الأسئلة (يجب أن يكون فوق الـ InkWell ليعمل بشكل مستقل)
          Positioned(
            bottom: 12.h,
            left: 16.w,
            child: ElevatedButton.icon(
              ...
              label: Text('إدارة الأسئلة', style: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.bold)),
  ...
  Widget _buildCardImage(Map<String, dynamic> content, int qCount) {
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(image: AssetImage('assets/images/path.jpeg'), fit: BoxFit.cover),
      ),
      child: Stack(
        children: [
          Container(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 4.w),
                  Text('سؤال $qCount', style: TextStyle(color: const Color(0xFF2D3748), fontSize: 11.sp, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
          ),
      ...
      child: Row(
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(value, style: TextStyle(fontSize: 22.sp, fontWeight: FontWeight.w900, color: const Color(0xFF2D3748))),
              Text(title, style: TextStyle(fontSize: 12.sp, color: const Color(0xFF718096))),
            ],
          )
        ],
      ),
  ...
  Widget _buildTypeBadge(String type) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isVideo ? const Color(0xFF4A90E2).withOpacity(0.1) : const Color(0xFFF6AD55).withOpacity(0.1),
        borderRadius: BorderRadius.circular(6.r),
      ),
      child: Text(type, style: TextStyle(color: isVideo ? const Color(0xFF4A90E2) : const Color(0xFFDD6B20), fontSize: 10.sp, fontWeight: FontWeight.w800)),
    );
  }
  ...
  Widget _buildEmptyState() {
    return Center(child: Text('لا يوجد محتوى متاح حالياً', style: TextStyle(fontFamily: 'Tajawal', color: Colors.grey.shade500, fontSize: 16.sp)));
  }
