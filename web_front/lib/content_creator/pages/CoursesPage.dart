...
class _CoursesPageState extends State<CoursesPage> {
            ...
            sliver: Obx(() {
              ...
              return SliverLayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final extent = cols == 1 ? 520.h : 460.h;
  ...
  Widget _buildCourseCard(Map<String, dynamic> content, ColorScheme cs) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: Colors.white, // ✅ خلفية بيضاء صريحة
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: _buildCardImage(questions.length, games.length, cs),
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    runSpacing: 8.h,
                    children: [
                      _chip(cs, Icons.quiz, '${questions.length} أسئلة'),
                      _chip(cs, Icons.videogame_asset, '${games.length} ألعاب'),
                    ],
                  ),
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton(
                          ...
                          child: const Text('إدارة الأسئلة'),
                        ),
                      ),
                      SizedBox(width: 8.w),
                      Expanded(
                        child: ElevatedButton(
                          ...
                          child: const Text('إدارة الألعاب'),
                        ),
                      ),
                    ],
                  )
  ...
  Widget _chip(ColorScheme cs, IconData icon, String text) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, size: 14.w, color: cs.primary),
          SizedBox(width: 6.w),
          Text(
            text,
            style: TextStyle(
  ...
  Widget _buildCardImage(int qCount, int gCount, ColorScheme cs) {
    return Stack(
      children: [
        Container(
          height: 160.h,
        ...
        Positioned(
          ...
          child: Row(
            ...
            children: [
              _miniStat(Icons.quiz, qCount),
              _miniStat(Icons.videogame_asset, gCount),
            ],
          ),
        ),
      ],
