...
class _ChildrenPageState extends State<ChildrenPage> {
              ...
              Padding(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    _buildDetailBox('رصيد النقاط', '${user['points_balance'] ?? 0} نقطة', Icons.star_rounded),
  ...
  Widget _pointsBadge(dynamic points) {
    final value = (points is num) ? points.toInt() : int.tryParse('${points ?? ''}') ?? 0;
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.star_rounded, size: 16.w, color: const Color(0xFFD97706)),
          SizedBox(width: 4.w),
          Text(
            '$value نقطة',
            style: TextStyle(
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      trailing: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          _pointsBadge(user['points_balance']),
                          SizedBox(width: 12.w),
                          ElevatedButton(
