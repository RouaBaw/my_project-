                    ...
                    Positioned(
                      ...
                      child: Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                          decoration: BoxDecoration(color: Colors.blue.withOpacity(0.9),
                              borderRadius: BorderRadius.circular(5)), child: Text('  فيديوهات ($videoCount) ($gameCount العاب) ', style: const TextStyle(color: Colors.white, fontSize: 11))),
                    ),
                  ],
  ...
  Widget _buildFooter(dynamic content) {
    return Row(
      children: [
        ...
        const Spacer(),
        TextButton(
          onPressed: () => Get.to(() => CourseVideosPage(courseTitle: content['title'], packages: content['packages'], questions: content['questions'] ,games: content['games'] ?? [])),
