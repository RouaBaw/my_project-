...
import 'package:web_front1/pages/subscription_review_page.dart';
...
class _AdminDashboardPageState extends State<AdminDashboardPage> {
  ...
  final List<Widget> _pages = [
    ...
    StoriesReviewQueuePage(),  // Index 2
    SubscriptionReviewPage(),  // Index 3
    AuditorsPage(),            // Index 4
    ParentsPage(),             // Index 5
    ChildrenPage()             // Index 6
  ];
